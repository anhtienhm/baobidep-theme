  ...
  <div class="wrap">
    ...
    <div class="sp-head">
      ...
      <div class="sp-meta rv" data-d="1">
        ...
        <?php else : ?>
        <div class="sp-buy sp-buy-contact">
          <a href="<?php echo esc_url(home_url('/#quote')); ?>" class="btn btn-gold"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6M9 13h6M9 17h6"/></svg>Liên hệ báo giá</a>
        </div>
        <?php endif; ?>
        <div class="sp-cta">
          <?php if ( $price > 0 ) : ?>
