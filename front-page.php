...
<section class="clients pad">
  <div class="wrap">
    ...
    <div class="clogos">
      ...
      <div class="clogo rv"><img src="<?php echo esc_url($up . 'Nestle-logo.png'); ?>" alt="Nestlé" loading="lazy"></div>
    </div>
  </div>
</section>
